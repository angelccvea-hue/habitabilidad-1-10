...
Fuente de verdad de menús. ``app.py`` lee ``NAV_SECTIONS`` / ids y despacha a
``page_*``. Si se agrega una pantalla nueva: declarar aquí el ``NavItem`` y
enganchar el ``id`` en el ``if/elif`` de ``app.main``.

Ver mapa de pantallas: ``docs/02-SECCIONES-UI.md``.
"""
